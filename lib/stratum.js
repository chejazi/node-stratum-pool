...
var HashingMeter = function(){
    var totalHashpower = 0;
    var userHashpower = {};
    return {
        update: function(id, hashrate) {
            hashrate = parseInt(hashrate);
            if (userHashpower.hasOwnProperty(id)) {
                totalRate -= userHashpower[id];
            };
            userHashpower[id] = hashrate;
            totalRate += hashrate;
        },
        remove: function(id) {
            if (userHashpower.hasOwnProperty(id)) {
                totalRate -= userHashpower[id];
                delete userHashpower[id];
            };
        },
        get: function() {
    ...
    function handleSubmit(message){
        ...
        _this.emit('submit',
            ...
            function(error, result){
                hashingMeter.update(options.subscriptionId, message.params[5]);
...
var StratumServer = exports.Server = function StratumServer(options, authorizeFn){
    ...
    this.removeStratumClientBySubId = function (subscriptionId) {
        hashingMeter.remove(subscriptionId);
    ...
    this.getHashpower = function() {
        return hashingMeter.get();
    };
